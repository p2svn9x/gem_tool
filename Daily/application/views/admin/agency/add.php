...
<?php if ($admin_info->status == "A") : ?>
    ...
    <div class="form-group">
        <div class="row">
            ...
            <label for="inputEmail3" class="col-sm-2 control-label">Số vin dư:&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;<label for="inputEmail3" class="control-label"
        ...
        <div class="row">
            ...
            <div class="col-sm-2">
                <select class="form-control" id="parent_name">
                    ...
                    <option value="<?php echo $dlmd ?>">Tổng đại lý miền đông</option>
                </select>
    ...
    <div class="form-group">
        <div class="row">
            <div class="col-sm-3"></div>
            <label for="inputEmail3" class="col-sm-1 control-label">Telegram:</label>
