...
<section class="content-header">
    <h1>
        Danh sách giftcode kho marketing
    </h1>
</section>
        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-body">
                    ...
                    <form action="<?php echo base_url('giftcode/giftcodemkt') ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <span class="glyphicon glyphicon-calendar"></span>
                            ...
                            <div class="col-sm-1"><input type="reset" value="Reset" name="submit"
                                                         class="btn btn-primary pull-left" id="reset"  onclick="window.location.href = '<?php echo base_url('giftcode/giftcodemkt') ?>'; "></div>
...
$(document).ready(function () {
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url('giftcode/giftcodemktajax') ?>",
        data: {
            roomvin: $("#roomvin").val(),
