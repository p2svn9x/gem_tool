                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-xs-2 col-sm-2 col-md-2"></div>
                                <label id="labelvin" class="col-xs-2 col-sm-2 col-md-1 control-label">Thời gian hoàn trả phí:</label>
                                <div class="col-xs-3 col-sm-3 col-md-2">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-xs-2 col-sm-2 col-md-2"></div>
                                <label id="labelvin" class="col-xs-2 col-sm-2 col-md-1 control-label">Thời gian thưởng doanh số:</label>
                                <div class="col-xs-3 col-sm-3 col-md-2">
