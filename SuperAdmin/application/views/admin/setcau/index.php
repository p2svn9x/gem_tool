...
<section class="content-header">
    ...
    <a  class="ajax" href="<?php echo base_url('setcau/setcauadd') ?>"><input type="button" class="btn btn-primary pull-right" value="Thêm cầu tài xỉu" style="margin-right: 10px; margin-bottom: 10px"></a>
