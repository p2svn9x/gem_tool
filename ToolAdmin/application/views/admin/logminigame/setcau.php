        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable withCheck" id="checkAll">
            ...
            <?php foreach ($list as $key => $value): ?>
                    ...
                    <tr>
                        ...
                        <td class="option">
                            <a href="<?php echo admin_url('logminigame/setcauadd') ?>" title="Thêm mới"
                               class="tipS lightbox">
                                <img src="<?php echo public_url('admin') ?>/images/add-icon.png"/>
                            </a>
                            <a title="Sửa cầu" class="tipS lightbox"
                               href="<?php echo admin_url('logminigame/setcauedit/' . $key) ?>">
                                <img src="<?php echo public_url('admin/images') ?>/edit-icon.png">
                            </a>
                            <a href="<?php echo admin_url('logminigame/delete/' . $key) ?>" title="Xóa"
