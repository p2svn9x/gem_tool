...
<div class="wrapper">
   ...
   <link rel="stylesheet" href="<?php echo public_url() ?>/site/bootstrap/bootstrap.min.css">
    ...
    <div class="widget">
        ...
        <div class="formRow"> <h5>Tổng số tin nhắn gửi đi:<span style="color: #0000ff" id="summessend"></span></h5> <h5>Tổng só tin nhắn thành công:<span style="color: #0000ff" id="summessuc"></span></h5></div>
