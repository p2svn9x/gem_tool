...
<?php else: ?>
    <div class="wrapper">
        ...
        <div class="widget">
            ...
            <div class="title">
                <h6>Lịch sử nạp vin qua ngân lượng</h6>
            </div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><select id="select_status" name="select_status"
                                    ...
                                    <option value="00" <?php if($this->input->post('select_status') == "00" ){echo "selected";}  ?> selected="selected">Thành công</option>
                                    <option  value="" <?php if($this->input->post('select_status') == "" ){echo "selected";} ?>>Tát cả</option>
