            ...
            <div class="widget">
                ...
                <div class="tab_container">
                    <div class="tab-content" id="tab1" style="display: block;">
                        ...
                        <div class="formRow">
                            <label for="param_name" class="formLeft">Người đăng:<span class="req">*</span></label>
                            <div class="formRight">
                                <span class="oneTwo"><input type="text" _autocheck="true" id="param_username" value="<?php echo $news->usernamepost ?>" name="username"></span>
                                <span class="autocheck" name="name_autocheck"></span>
                                <div class="clear error" name="name_error"></div>
                            </div>
                            <div class="clear"></div>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input type="text" _autocheck="true" id="param_desc" value="<?php echo $news->description ?>" name="desc"></span>
                                <span class="autocheck" name="name_autocheck"></span>
                                <div class="clear error" name="name_error"></div>
                            </div>
                            <div class="clear"></div>
                                        ...
                                        <?php if (count($row->subs) > 1): ?>
                                            <optgroup label="<?php echo $row->name ?>">
                                                <?php foreach ($row->subs as $sub): ?>
                                                    <option value="<?php echo $sub->id ?>" <?php if ($sub->id == $news->catalog_id) echo 'selected'; ?>> <?php echo $sub->name ?> </option>
                                                <?php endforeach; ?>
                                            </optgroup>
                                        <?php else: ?>
                                            <option value="<?php echo $row->id ?>" <?php if ($row->id == $news->catalog_id) echo 'selected'; ?>><?php echo $row->name ?></option>
                                        <?php endif; ?>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="formRow">
                            <label for="param_cat" class="formLeft">Tag:<span class="req">*</span></label>
                            <div class="formRight">
                                <select name="tag" class="left">
                                    <option value=""></option>
                                    <!-- kiem tra danh muc co danh muc con hay khong -->
                                    <?php foreach ($tags as $row): ?>
                                        <option value="<?php echo $row->id ?>" <?php if ($row->id == $news->tag_id) echo 'selected'; ?>><?php echo $row->tag_name ?></option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <div class="left">
                                    <input type="file" name="image" id="image" value="" size="25">
