        ...
        <table width="100%" cellspacing="0" cellpadding="0" id="checkAll" class="sTable mTable myTable">
            ...
            <tr>
                <td colspan="8">
                    <div class="list_action itemActions">
                        <a url="<?php echo admin_url('news/delete_all') ?>" class="button blueB" id="submit"
                           href="#submit">
            ...
            <?php foreach ($list as $row): ?>
                <tr class="row_<?php echo $row->id ?>">
                    ...
                    <td class="textC"><?php echo $row->catalog_name ?></td>
                    <td class="textC"><?php echo $row->tag_name ?></td>
                    <td class="textC"><?php echo get_date($row->create_date) ?></td>
                    <td class="option textC">
                        ...
                        <a class="tipS verify_action" title="Xóa"
                           href="<?php echo admin_url('news/del/' . $row->id) ?>">
