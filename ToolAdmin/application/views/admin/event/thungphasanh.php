...
<script>
    ...
    $(function () {
        ...
        $('#deleteManyBtn').click(function () {
            ...
            deleteTopCaoThap(ids);
        })

    });
    function resultSearchtaixiu(stt, nickname, hand, money,date,prize, id) {
        var rs = "";
        rs += "<tr>";
        ...
        rs += "<td>" + date + "</td>";
        rs += "<td>" + prize + "</td>";
        rs += "<td><button onclick='deleteTopCaoThap(\""+id+"\")' class='btn btn-sm btn-danger'>Xóa</button></td>";
        rs += "</tr>";
        return rs;
    }
    ...
    $("#search_tran").click(function () {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo admin_url('event/thungphasanhajax')?>",
            data: {
                month: $("#txtmonth").val(),
                day: $("#txtday").val(),
                top: $("#top").val(),
            ...
            success: function (result) {
                ...
                if (result.results == "") {
                    ...
                    $.each(result.results, function (index, value) {
                        result += resultSearchtaixiu(value.stt, value.nickname, value.hand, value.money, value.timestamp,value.prize, value.id);
    ...
    function deleteTopCaoThap(ids) {
        if(!confirm('Bạn muốn xóa?')) return false;
        $("#spinner").show();
        $.post('<?php echo admin_url('event/deletecaothapjax')?>', {
            ids: ids
        }, function (re) {
            $("#spinner").hide();
            if(re.success){
