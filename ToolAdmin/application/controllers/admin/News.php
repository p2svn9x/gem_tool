    ...
    function add()
    {
        ...
        if ($this->input->post()) {
            ...
            if ($this->form_validation->run()) {
                ...
                $catalog_name = $this->catalog_model->get_info($catalog_id);
                $tag_id = $this->input->post('tag');
                $tag_name = $this->tag_model->get_info($tag_id);
                ...
                $data = array(
                    ...
                    'create_date' => now(),
                    'usernamepost' => $this->input->post('username'),
                    'slug' => $this->create_slug($this->input->post('title')),
                    'catalog_id' => $catalog_id,
                    'catalog_name' => $catalog_name->name,
                    'tag_id' => $tag_id,
